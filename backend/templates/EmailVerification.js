exports.Verification_Email_Template = `
  ...
  <body>
      <div class="container">
          ...
          <div class="footer">
              <p>&copy; ${new Date().getFullYear()} OptaCloud. All rights reserved.</p>
          </div>
      </div>
  </body>
  </html>
...
exports.Welcome_Email_Template = `
  ...
  <head>
      <meta charset="UTF-8">
      <meta name="viewport" content="width=device-width, initial-scale=1.0">
      <title>Welcome to OptaCloud</title>
      <style>
          body {
              font-family: Arial, sans-serif;
              margin: 0;
  ...
  <body>
      <div class="container">
          <div class="header">Welcome to OptaCloud!</div>
          <div class="content">
              <p class="welcome-message">Hello {name},</p>
              <p>We're excited to have you join **OptaCloud**, your new favorite place to connect and communicate seamlessly with Friends, family, and colleagues.</p>
              ...
              <p>To make the most out of OptaCloud, we recommend setting up your profile and adding contacts:</p>
              <ul>
                  <li>Complete your profile with a photo and bio.</li>
                  <li>Invite Friends to join OptaCloud.</li>
